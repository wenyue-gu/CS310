...
Note that we won't test this tool with our automated tests.
...
The tests you run should be more or less identical to the ag350 tests.
So once you have all the tests passing, go ahead and try and submit.
...
for the Duke context by Mike Hewner.
